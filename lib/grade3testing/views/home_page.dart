...
class grade3testhome extends StatefulWidget {
  @override
  _grade3testhomeState createState() => _grade3testhomeState();
}

class _grade3testhomeState extends State<grade3testhome> {
  int _indexPage = 0;
  List<Widget> _pages = [
    PageLearning(),
    // PageVideo(),
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
            ...
            onPressed: () => Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => Testtraintrackgrade2()))),
      ),
      // drawer: DrawerCustom(),
