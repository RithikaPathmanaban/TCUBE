...
class _mathQuzeAppState extends State<mathQuze> {
  final _questions = const [
    {
      'question': 'Q1:Does your child repeat the answer?',
      'answers': [
        {'text': 'Yes', 'score': 10},
        {'text': 'No', 'score': 0},
    ...
    {
      'question':
          'Q2: Is there any confusion on understanding multiplication or division?',
      'answers': [
        {'text': 'Yes', 'score': 0},
        {'text': 'No', 'score': 10},
        {'text': 'Moderate', 'score': 5},
    ...
    {
      'question': 'Q3: Does your child identify the method?',
      'answers': [
        {'text': 'Yes', 'score': 10},
        {'text': 'No', 'score': 0},
        {'text': 'Moderate', 'score': 5},
    ...
    {
      'question': 'Q4: Does your child get strucked in any concept?',
      'answers': [
        {'text': 'Yes', 'score': 0},
        {'text': 'No', 'score': 10},
        {'text': 'Moderate', 'score': 5},
