...
class AlphabetScreen2 extends StatefulWidget {
  @override
  _AlphabetScreen2State createState() => _AlphabetScreen2State();
}

class _AlphabetScreen2State extends State<AlphabetScreen2> {
