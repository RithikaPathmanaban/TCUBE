...
class equal1 extends StatefulWidget {
  const equal1({Key? key}) : super(key: key);

  @override
  State<equal1> createState() => _equal1State();
}

class _equal1State extends State<equal1> {
  @override
            ...
            children: [
              Center(
                child: Container(
                  ...
                  width: 150,
                  child: Image(
                    image: AssetImage('assets/images/eq1.png'),
                  ),
                ),
              ),
              // SizedBox(height: 20),
              Center(
                child: Container(
                  ...
                  width: 150,
                  child: Image(
                    image: AssetImage('assets/images/eq2.png'),
                  ),
                ),
              ),
            ],
