...
import 'package:kids_learning/grade4testing/quize/quizbanner.dart';
...
class _sensoryQuzeAppState extends State<sensoryQuze> {
  final _questions = const [
    {
      'question': 'Q1:Does your child do these activities correctly?',
      'answers': [
        {'text': 'Yes', 'score': 10},
        {'text': 'No', 'score': 0},
    ...
    {
      'question': 'Q2: Is there any confusion on the actions??',
      'answers': [
        {'text': 'Yes', 'score': 0},
        {'text': 'No', 'score': 10},
        {'text': 'Moderate', 'score': 5},
    ...
    {
      'question': 'Q3:Does your child touches the body part correctly?',
      'answers': [
        {'text': 'Yes', 'score': 10},
        {'text': 'No', 'score': 0},
        {'text': 'Moderate', 'score': 5},
        ...
        appBar: AppBar(
            ...
            leading: IconButton(
              ...
              onPressed: () => Navigator.push(context,
                  MaterialPageRoute(builder: (context) => sensoryScreen1())),
            )),
