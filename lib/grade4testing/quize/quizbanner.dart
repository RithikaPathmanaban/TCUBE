          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'Let your child read the homophones. In the end, there are some questions .Based on your child\'s reading level, please let us know where he is falling behind',
                  style: TextStyle(
    ...
    return Container(
      ...
      child: ElevatedButton(
        ...
        onPressed: () {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => homophones1()),
          );
        },
      ),
    );
