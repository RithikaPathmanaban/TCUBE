...
class grade1trainHomePage extends StatefulWidget {
  @override
  _grade1trainHomePageState createState() => _grade1trainHomePageState();
}

class _grade1trainHomePageState extends State<grade1trainHomePage> {
  int _indexPage = 0;
  List<Widget> _pages = [
    PageLearning(),
    // PageVideo(),
