...
class sensoryQuze1 extends StatefulWidget {
  const sensoryQuze1({Key? key}) : super(key: key);

  @override
  _sensoryQuze1AppState createState() => _sensoryQuze1AppState();
}

class _sensoryQuze1AppState extends State<sensoryQuze1> {
  final _questions = const [
    {
      'question': 'Q1:Does your child touch the body parts?',
      'answers': [
        {'text': 'YES', 'score': 10},
        {'text': 'NO', 'score': 0},
    ...
    {
      'question':
          'Q2: Does your child recognize the picture of the body part and his body?',
      'answers': [
        {'text': 'Yes', 'score': 0},
        {'text': 'No', 'score': 10},
        {'text': 'Moderate', 'score': 5},
    ...
    {
      'question': 'Q3:Does your child tell the body parts name?',
      'answers': [
        {'text': 'Yes', 'score': 10},
        {'text': 'No', 'score': 0},
        {'text': 'Moderate', 'score': 5},
