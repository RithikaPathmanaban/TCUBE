...
// import 'package:kids_learning/grade1/maths/main.dart';
...
import '../maths/main.dart';
import 'Quiz1.dart';
// import 'package:mrigrakksha/quiz/Quiz1.dart';

class mathsquizbannerg1Page extends StatefulWidget {
  mathsquizbannerg1Page({Key? key}) : super(key: key);

  @override
  _BannerPageState createState() => _BannerPageState();
}

class _BannerPageState extends State<mathsquizbannerg1Page> {
  @override
            ...
            children: [
              IconButton(
                  ...
                  onPressed: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => grade1testhome()))),
            ],
          ),
          Stack(
            children: [
