...
class Testtraintrackgrade2 extends StatefulWidget {
  // const Testtraintrack({super.key});

  @override
  State<Testtraintrackgrade2> createState() => _Testtraintrackgrade2State();
}

class _Testtraintrackgrade2State extends State<Testtraintrackgrade2> {
  @override
            ...
            child: Column(children: [
              ...
              GestureDetector(
                onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: ((context) => grade2training()))),
                child: Container(
                  alignment: Alignment.center,
                  child: _bannerCard1(),
                ),
