...
import '../grade3/main.dart';

// import 'package:tcube/login.dart';

class Testtraintrack0 extends StatefulWidget {
  // const Testtraintrack0({super.key});

  @override
  State<Testtraintrack0> createState() => _Testtraintrack0State();
}

class _Testtraintrack0State extends State<Testtraintrack0> {
  @override
            ...
            child: Column(children: [
              ...
              GestureDetector(
                onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: ((context) => grade1training()))),
                child: Container(
                  alignment: Alignment.center,
                  child: _bannerCard1(),
                ),
